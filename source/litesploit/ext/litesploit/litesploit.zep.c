...
PHP_METHOD(Litesploit_Litesploit, engine) {
	...
	ZEPHIR_CALL_SELF(NULL, "executecode", &_0, 23, location);
...
PHP_METHOD(Litesploit_Litesploit, executecode) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, libraries, "loader", NULL, 24, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_METHOD(&_0, variables, "loader", NULL, 25, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_METHOD(&_0, load, "loader", NULL, 26, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_METHOD(&_0, statement, "loader", NULL, 27, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_INIT_VAR(_1);
