...
PHP_METHOD(Litesploit_Intepreter_Statement, loader) {
	...
	ZEPHIR_CALL_SELF(&_0, "switch_statement", &_1, 7, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_SELF(&_0, "while_statement", &_2, 8, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_SELF(&_0, "if_statement", &_3, 9, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
	ZEPHIR_CALL_SELF(&_0, "for_statement", &_4, 10, litesploit);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(litesploit, _0);
